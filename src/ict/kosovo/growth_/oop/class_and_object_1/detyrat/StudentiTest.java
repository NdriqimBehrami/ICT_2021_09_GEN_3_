...
public class StudentiTest {
    public static void main(String[] args) {
       Studenti account = new Studenti();
        ...
        System.out.printf("Studenti me emrin: %s mbiemer: %s me numer te id-s: %d me drejtimin: %s te gjenerates: %d me note mesatare: %.2f dhe me lokacion ne: %s %n", account.getEmri(),
                account.getMbiemri(),account.getId(),account.getDrejtimi(),account.getGjenerata(),account.getNotaMesatare(),account.getDrejtimi());
    }
