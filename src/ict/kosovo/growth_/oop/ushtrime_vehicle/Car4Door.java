...
public class Car4Door extends Car{
    private int numriDyerve;
    private int numriUlseve;

    public Car4Door(String ngjyra, String modeli, int vitiProdhimit, double cmimi, String llojiKarburantit, double madhsiaMotorrit, int numriDyerve, int numriUlseve) {
