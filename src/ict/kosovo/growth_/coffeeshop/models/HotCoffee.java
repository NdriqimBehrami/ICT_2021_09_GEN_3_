...
public class HotCoffee extends Coffee{
    public HotCoffee(String name, char size, boolean withMilk, BigDecimal price, Rating rating, List<Review> reviews) throws NegativePriceException {
        super(name, size, withMilk, price, rating,reviews);
    }

    public HotCoffee(String name, char size, BigDecimal price) throws NegativePriceException {
